...
const event_data = [{
        ...
        "tagsEn": [, "Conference", "Model United Nations", "Juniors", "High School", ],
    },
    {
        "id": "GOC14G",
        "title": "模擬G7サミット",
        "tags": ["英語", "会議", "MG7", "中学生", "高校生", ],
        ...
        "tagsEn": ["English", "Conference", "MG7", "Juniors", "High School", ],
    },
    {
        "id": "GOC05G",
        "title": "ビブリオバトル国際大会",
        "tags": ["英語企画", "競技", "図書", "ビブリオバトル", "中学生", "高校生", ],
        ...
        "tagsEn": ["English", "Competition", "Books", "Bibliobattle", "Juniors", "High School", ],
    },
    {
        "id": "GOC13G",
        "title": "数マラソン2022、Mathalon2022",
        "tags": ["英語企画", "競技", "数学", "中学生", "高校生", ],
        ...
        "tagsEn": ["English", "Competition", "Math", "Juniors", "High School", ],
    },
    {
        "id": "GON15P",
        "title": "SOLA International Book Talk 2022",
        "tags": ["英語企画", "プロジェクト", "図書", "中学生", "高校生", ],
        ...
        "tagsEn": ["English", "Project", "Books", "Juniors", "High School", ],
    },
    {
        "id": "DOC03N",
        "title": "模擬国連SOLA国内会議",
        "tags": ["日本語企画", "会議", "模擬国連", "中学生", "高校生", ],
        ...
        "tagsEn": ["Japanese", "Conference", "Model United Nations", "Juniors", "High School", ],
    },
    {
        "id": "DFN06N",
        "title": "2050の日本を描く",
        "tags": ["日本語企画", "会議", "中学生", "高校生", ],
        ...
        "tagsEn": ["Japanese", "Conference", "Juniors", "High School", ],
    },
    {
        "id": "DON07N",
        "title": "アパレル×環境~繊維の隙間から見る環境問題~",
        "tags": ["日本語企画", "会議", "環境", "中学生", "高校生", ],
        ...
        "tagsEn": ["Japanese", "Conference", "Environment", "Juniors", "High School", ],
    },
    {
        "id": "DOC08N",
        ...
        "tagsEn": ["Japanese", "Conference", "Juniors", ],
    },
    {
        "id": "DON09N",
        "title": "1億総SDGs",
    ...
    },
    {
        ...
        "tagsEn": ["Japanese", "Conference", "Education", "Juniors", "High School", ],
    },
    {
        "id": "DOC04N",
        "title": "ビブリオバトル全国大会2022",
        "tags": ["日本語企画", "競技", "図書", "ビブリオバトル", "中学生", "高校生", ],
        "disc": `　ビブリオバトルは日本発祥の書評合戦です。バトラーはそれぞれの“推し本”を1冊持ち寄り、順番に紹介していきます。一通り発表が終わったら、観客と参加者は「1番読みたくなった本」に投票し、チャンプ本を決めます。<br>　去年のSOLAでは、魅力的な本とバトラー達のプレゼンによって白熱したバトルが行われました。そして今回2回目のビブリオバトルを開催します！今回も前回と同様、「本を読む」という点からSDGsを多角的に捉えるということ、そしてビブリオバトルの魅力をSOLAの場をかりて世界に発信していきたいです。<br>　ビブリオバトルの魅力はなんと言っても、普段読まないような本と出会えること。インターネットや図書館、本屋に行っても興味のない題材に挑戦するのは案外難しいものです。<br>　ビブリオバトルはあなたとは違う「好み」を色々な人達が持ち寄る場でもあります。<br>　バトラーでなくともたくさんの方々にこのビブリオバトルに立ち寄って頂きたいです。<br>　渋谷の地を飛び出し、素晴らしいたくさんの本に皆さんが出会えれば幸いです。`,
        "participationRight": `(1)中学生または高校生であること<br>(2)各校1人まで応募できます`,
        ...
        many people bring forth their own interests and passions. Even if you're not a battler, please be welcome to join. We hope that everyone could come across great books beyond the city of Shibuya.`,
        "participationRightEn": `(1)Currently attending junior or senior high school<br>(2)Only one person per school may apply `,
        "tagsEn": ["Japanese", "Competition", "Books", "Bibliobattle", "Juniors", "High School", ],
    },
    {
        "id": "DON11J",
        ...
        "tagsEn": ["Japanese", "Presentation", "High School", ],
    },
    {
        "id": "DON12W",
        "title": "未来のスマートシティを作ろう〜ロボット×SDGs〜",
        "tags": ["日本語企画", "ワークショップ", "科学", "ロボット", "中学生", "高校生", ],
        ...
        "tagsEn": ["Japanese", "Workshop", "Science", "Robot", "Juniors", "High School", ],
    },
    {
        "id": "DOC17W",
        "title": "メンタルヘルスの未来",
        "tags": ["日本語企画", "ワークショップ", "健康", "中学生", "高校生", ],
        ...
        "tagsEn": ["Japanese", "Workshop", "Health", "Juniors", "High School", ],
    },
    ...
    // },
    {
        ...
        "tagsEn": ["Special Event", "Competition", "Debate", "Juniors", "High School", ],
    },
];