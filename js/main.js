...
const event_data = [{
    ...
    },
    {
        ...
        "titleEn": "SOLA Cup 2022 High School International Debate Tournament (In November)",
    ...
    },
    {
        ...
        "disc": "　ビブリオバトルは日本発祥の書評合戦です。バトラーはそれぞれの“推し本”を1冊持ち寄り、順番に紹介していきます。一通り発表が終わったら、観客と参加者は「1番読みたくなった本」に投票し、チャンプ本を決めます。\n　去年のSOLAでは、魅力的な本とバトラー達のプレゼンによって白熱したバトルが行われました。そして今回2回目のビブリオバトルを開催します！今回も前回と同様、「本を読む」という点からSDGsを多角的に捉えるということ、そしてビブリオバトルの魅力をSOLAの場をかりて世界に発信していきたいです。\n　ビブリオバトルの魅力はなんと言っても、普段読まないような本と出会えること。インターネットや図書館、本屋に行っても興味のない題材に挑戦するのは案外難しいものです。\n　ビブリオバトルはあなたとは違う「好み」を色々な人達が持ち寄る場でもあります。\n　バトラーでなくともたくさんの方々にこのビブリオバトルに立ち寄って頂きたいです。\n　渋谷の地を飛び出し、素晴らしいたくさんの本に皆さんが出会えれば幸いです。",
        "participationRight": "(1)中学生または高校生であること\n(2)各校1人まで応募できます",
        "titleEn": "ビブリオバトル SOLA 全国大会 2022",
...
THREE.Loader.prototype = {
    ...
    addStatusElement: function() {
        ...
        a.style.background = "rgba(0,0,255,0.25)";
        a.style.color = "#fff";
        a.style.width = "120px";
    ...
    var wd = function(a) {
            ...
            if (void 0 !== a.geometryGroups)
                for (var c in a.geometryGroups) {
                    ...
                    if (void 0 !== d.numMorphNormals) { e = 0; for (f = d.numMorphNormals; e < f; e++) j.deleteBuffer(d.__webglMorphNormalsBuffers[e]) }
                    b(d)
                }
            b(a);
...
THREE.GeometryUtils = {
    ...
    randomPointsInGeometry: function(a, b) {
        function c(a) {
            function b(c, d) { if (d < c) return c; var e = c + Math.floor((d - c) / 2); return k[e] > a ? b(c, e - 1) : k[e] < a ? b(e + 1, d) : e }
...
THREE.ExtrudeGeometry.prototype.addShape = function(a, b) {
    ...
    } else { for (M = 0; M < Ca; M++) h = W[M], g(h[2], h[1], h[0], !0); for (M = 0; M < Ca; M++) h = W[M], g(h[0] + fa * s, h[1] + fa * s, h[2] + fa * s, !1) }
    h = 0;
    e(r, h);
    h += r.length;
    G = 0;
...
THREE.CameraHelper.prototype.update = function() {
    function a(a, d, e, f) {
        ...
        a = b.pointMap[a];
        if (void 0 !== a) { d = 0; for (e = a.length; d < e; d++) b.geometry.vertices[a[d]].copy(THREE.CameraHelper.__v) }
    }
    var b = this;
