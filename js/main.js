...
const event_data = [{
    ...
    },
    {
        ...
        "disc": "全国の中高生が連携して、地方ごとの教育の特色、問題意識を共有。解決策をディスカッションし、外部への提言を作成する企画です。\n\n『TOEICやTOEFLなど、英語の外部試験は県内で受けられるものが少なく、県をまたぎ会場に行かなければならない。』\n『自治体の財政力の差から、公共教育施設数の差が大きい。』\n『都会の人たちがボランティア活動や模擬国連への参加、海外経験をしているなか、青森の高校生たちは同い年の子がそんな活動をしていることすら知らなかった。』\n「予備校、大学が少ない。 学校、塾の先生が少なく、専門外の授業を担当する先生も。」\n\nこれらは、私達が岩手県や秋田県で学ぶ中高生に行ったアンケートや、論文や記事等の事前調査から得られた声です。\n地方に生まれたということだけで、都心部の人たちと教育、自身のスキルアップにつながる機会に差が大きく生じてしまう。この日本には、そんな問題が確かに存在します。\n実際、地方出身の運営メンバー二人は東京に来て、地方との教育のギャップを身をもって感じることがありました。\nこのイベントは、そんな運営メンバーの実体験に基づく想いから発案されたものです。\n大泉　孝誠(発案者)\n「久しぶりに話した地元の友達が学校の不満をこぼすのを聞いて、この問題に関心を抱き、早急に改善されるべきと強く感じました。しかし、ただ関心を持つだけでは何も変わりません。当事者である僕達中高生が主体的にこの問題に向き合い、有効な解決策を考案することこそが、この問題を解決する第一歩となるでしょう。｣ \n\n本企画は、様々な地域の同世代と地域によって異なる教育の現状と問題点を共有し、実際に解決案をディスカッション、最終的には運営メンバーの手で実行することが目的です。地域の垣根を超えて、学生が平等な教育に働きかけることは類を見ない活動です。\n地方の原石が埋もれてしまう、これは日本の大きな損失です。全国の中高生と協力して、この問題に一石を投じてみませんか。",
        "participationRight": "(1) 日本の中高生であること",
        "titleEn": "地域に縛られない平等な教育を目指そう",
        "discEn": "全国の中高生が連携して、地方ごとの教育の特色、問題意識を共有。解決策をディスカッションし、外部への提言を作成する企画です。\n\n『TOEICやTOEFLなど、英語の外部試験は県内で受けられるものが少なく、県をまたぎ会場に行かなければならない。』\n『自治体の財政力の差から、公共教育施設数の差が大きい。』\n『都会の人たちがボランティア活動や模擬国連への参加、海外経験をしているなか、青森の高校生たちは同い年の子がそんな活動をしていることすら知らなかった。』\n「予備校、大学が少ない。 学校、塾の先生が少なく、専門外の授業を担当する先生も。」\n\nこれらは、私達が岩手県や秋田県で学ぶ中高生に行ったアンケートや、論文や記事等の事前調査から得られた声です。\n地方に生まれたということだけで、都心部の人たちと教育、自身のスキルアップにつながる機会に差が大きく生じてしまう。この日本には、そんな問題が確かに存在します。\n実際、地方出身の運営メンバー二人は東京に来て、地方との教育のギャップを身をもって感じることがありました。\nこのイベントは、そんな運営メンバーの実体験に基づく想いから発案されたものです。\n大泉　孝誠(発案者)\n「久しぶりに話した地元の友達が学校の不満をこぼすのを聞いて、この問題に関心を抱き、早急に改善されるべきと強く感じました。しかし、ただ関心を持つだけでは何も変わりません。当事者である僕達中高生が主体的にこの問題に向き合い、有効な解決策を考案することこそが、この問題を解決する第一歩となるでしょう。｣ \n\n本企画は、様々な地域の同世代と地域によって異なる教育の現状と問題点を共有し、実際に解決案をディスカッション、最終的には運営メンバーの手で実行することが目的です。地域の垣根を超えて、学生が平等な教育に働きかけることは類を見ない活動です。\n地方の原石が埋もれてしまう、これは日本の大きな損失です。全国の中高生と協力して、この問題に一石を投じてみませんか。",
